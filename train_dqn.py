...
# Import the DQN agent implementation
...
def create_advanced_plots(scores, avg_scores, epsilons, steps_per_episode, losses=None):
    ...
    ax1.set_title('Buildings Passed Over Training (DQN)')  # Plot title
    ...
    ax2.set_title('Survival Time Progression (DQN)')  # Plot title
    ...
    ax3.set_title('Buildings Passed vs Exploration Rate (DQN)')  # Plot title
    ...
    ax4.set_title('Buildings Passed vs Survival Time (DQN)')  # Plot title
    ...
    if losses:  # If loss data was provided
        ...
        ax5.set_title('Exploration Rate Decay and Training Loss (DQN)')  # Plot title
        ...
        ax5.set_title('Exploration Rate (Epsilon) Decay (DQN)')  # Plot title
    
    # Adjust layout for optimal spacing
    plt.tight_layout()
    # Save high-resolution figure to file
...
def train():
    ...
    os.makedirs('checkpoints_dqn', exist_ok=True)  # For model checkpoints
    os.makedirs('plots_dqn', exist_ok=True)  # For plots
    ...
    # Initialize DQN agent with appropriate dimensions
